...
class Trainer:
    ...
    def cross_entropy(self, seq_out, pos_ids, neg_ids):
        ...
        seq_emb = seq_out.view(-1, self.args.reshape_size) # [batch*seq_len hidden_size]
    ...
    def iteration(self, epoch, dataloader, full_sort=False, train=True):
        ...
        if train:
            ...
            for i, batch in rec_data_iter:
                ...
                rec_cur_loss = (self.args.rq_loss_weight * rq_loss + cross_loss).item()
...
class Initializer(Trainer):

    def __init__(self, model,
                 semantic_dataloader, train_dataloader,
            eval_dataloader,
            test_dataloader, args):
        ...
        self.model = model
        self.semantic_dataloader = semantic_dataloader
        # super(Initializer, self).__init__(
        self.args = args
        #     model,
        #     semantic_dataloader,
    ...
    def initialize(self):
        ...
        dataloader = self.semantic_dataloader
        # Setting the tqdm progress bar
        str_code = "initialize"
        epoch = 1
        rec_data_iter = tqdm.tqdm(enumerate(dataloader),
