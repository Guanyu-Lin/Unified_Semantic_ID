...
from utils import EarlyStopping, get_user_attribute_seq, get_item2attribute_json, check_path, set_seed
...
def main():
    ...
    parser.add_argument('--code_embedding_file', default='Beauty132cos.pt', type=str)
    ...
    parser.add_argument("--codebook_size", type=int, default=3, help="codebook size of transformer model")
    parser.add_argument("--attribute_size", type=int, default=256, help="number of each codebook")
    ...
    args.code_embedding_file = args.data_name + str(args.attribute_size) + str(1.0) + str(32) + 'cos.pt'
    args.semantic_name = args.data_name + str(args.attribute_size) + str(1.0) + str(32) + "cosidToSemanticId.json"
    os.environ["CUDA_VISIBLE_DEVICES"] = args.gpu_id
    args.cuda_condition = torch.cuda.is_available() and not args.no_cuda

    args.data_file = args.data_dir + args.data_name + '.txt'
    item2attribute_file = args.data_dir + args.semantic_name

    # item2attribute_file = args.data_dir + args.data_name + 'idToSemanticId_lowhit.json'
    attribute2item, item2attribute, attribute_size = get_item2attribute_json(item2attribute_file, args.codebook_size)
    print("semantic_num", len(attribute2item))

    user_seq_attribute, user_seq, max_item, valid_rating_matrix, test_rating_matrix = \
        get_user_attribute_seq(args.data_file, item2attribute, args.codebook_size)
    ...
    # model.concate_embedding(device=device)
