...
python train_sample.py --embedding_type 'add_reshape' --hidden_size 64 --codebook_size 3 --semantic_dim_size 32 --id_dim_size 64 --reshape_size 64 --attribute_size 512
