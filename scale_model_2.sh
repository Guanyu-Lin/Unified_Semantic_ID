...
python train_semantic_full.py --embedding_type 'semantic_id_concat' --hidden_size 32 --codebook_size 3 --semantic_dim_size 64 --id_dim_size 64
#python train_semantic_full.py --embedding_type 'semantic_id_concat' --hidden_size 256 --codebook_size 3 --semantic_dim_size 64 --id_dim_size 64
